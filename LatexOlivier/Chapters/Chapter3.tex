...
\begin{figure}[htp]
	\begin{minipage}[c]{.46\linewidth}
		\centering
		\includegraphics[width=8cm]{e0e1_Pdelta}
	...
	\begin{minipage}[c]{.46\linewidth}
		\centering
		\includegraphics[width=8cm]{e0e5_Pdelta}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=12.5cm]{G_method2}
	\caption{Gmethod2}
	\label{fig:G_method2}
\end{figure}
...
\begin{table} [H]
	...
	\begin{tabular}{ccccccc}
		...
		& Gmax method1 & 273.87 & 90.24 & 107.49 & 95.67 & 183.58 \\\midrule
		& Gmax method2 & 319.31 & 131.16 & 206.73 & 93.83 & 199.59 \\\midrule
	\end{tabular}
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{cccccccc}
			...
			\midrule
			& & \textbf{Silver fir} & \textbf{2MCG} & \textbf{RL} & \textbf{0.43} & \textbf{172} & \textbf{82} \\
			\midrule
