...
Initial crack lengths are obtained by the average of the surfacic precrack and the real interior precrack. The equation used is :

\begin{equation}
	a_0=l_{notch}+\frac{l_{surfacic}+l_{interior}}{2}
	\label{eq:precrack}
\end{equation}

with $a_0$ the initial crack length, $l_{notch}$ the notch length, $l_{surfacic}$ the surfacif precrack, $l_{interior}$ the real interior precrack.

\subsection{Specimen names}

We have 20 specimens of pinus pinaster of 12.5mm thickness.
