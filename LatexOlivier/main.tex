...
We analyze mixed mode and open I mode crack growth, and from the measurements, we produce force versus crack opening curves. In addition, we use the imposed displacement compliance method to determine the strain energy release rate for opening mode and mixed mode.
