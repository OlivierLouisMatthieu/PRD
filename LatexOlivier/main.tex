...
Nous nous concentrons sur la croissance des fissures ouvertes en mode I et mode mixte, puis nous générons des courbes de force en fonction de l'ouverture de la fissure à partir des mesures. En outre, nous utilisons la méthode de la complaisance à déplacement imposé pour déterminer le taux de libération de l'énergie de déformation pour le mode d'ouverture.
...
\vspace{2cm}
This PRD took place at the University Nova of science and technology in Caparica. I would like to thank this university for its help during the whole research period. Indeed, I am grateful for the scientific supervision provided by my tutors as well as for the quality of the facilities available at this university.
...
\textbf{VSG} & \textbf{V}irtual \textbf{S}tain \textbf{G}auge\\
